{
  ...
  inputs = {
    ...
    catppuccin.inputs.nixpkgs-stable.follows = "";
    catppuccin.inputs.home-manager.follows = "";
    catppuccin.inputs.home-manager-stable.follows = "";
    catppuccin.inputs.nuscht-search.follows = "";
    catppuccin.inputs.catppuccin-v1_1.follows = "";
    catppuccin.inputs.catppuccin-v1_2.follows = "";
