...
caddy.withPlugins {
  plugins = [
    "pkg.jsn.cam/caddy-defender@v0.0.0-20251221022141-9adfd7e6da47" # pinned (https://nixpkgs-tracker.ocfox.me/?pr=467201)
  ...
  hash = "sha256-XYrbGdOYhuInC2XI7vgrFDoSUpL8MoxPmGD5N0K1Yhs=";
}
