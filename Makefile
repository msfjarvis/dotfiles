...
SCRIPTS_TO_TEST += setup/gdrive.sh setup/hugo.sh setup/hub.sh setup/llvm.sh setup/nano.sh setup/ripgrep.sh setup/shellcheck.sh
SCRIPTS_TO_TEST += setup/xclip.sh setup/zulu-jdk.sh
